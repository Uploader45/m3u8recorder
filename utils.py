...
def multi_rip(client, message, streamUrl, channel, recordingDuration, language, ripType, ripQuality, fileTitle):
    ...
    video_opts_2 = '-to'
    video_opts_3 = '-map 0:v:0 -map 0:a -metadata:s:a:0 title="TeamTCI" -metadata:s:a:1 title="TeamTCI" -metadata:s:a:2 title="TeamTCI" -metadata:s:a:3 title="TeamTCI" -metadata:s:a:4 title="TeamTCI" -metadata:s:a:5 title="TeamTCI" -metadata:s:a:6 title="TeamTCI"'
